...
## [0.1.45](https://github.com/shivmohith/openinference/compare/python-openinference-instrumentation-v0.1.44...python-openinference-instrumentation-v0.1.45) (2026-02-02)


### Features

* add context manager for capturing openinference spans ([#1781](https://github.com/shivmohith/openinference/issues/1781)) ([aab3386](https://github.com/shivmohith/openinference/commit/aab33868276627705f3e83fe8898429b71a23695))
...
* add Open Agent Spec Instrumentor ([#2560](https://github.com/shivmohith/openinference/issues/2560)) ([48a8722](https://github.com/shivmohith/openinference/commit/48a87228767089416bbe608a8ff782923c9db5b5))
* Allow to hide llm.prompts span from trace config ([#1863](https://github.com/shivmohith/openinference/issues/1863)) ([7d633d8](https://github.com/shivmohith/openinference/commit/7d633d8fcf6ab5dbd8596a5900f3982db8e88d89))
* increase default span attribute count limit to 10,000 ([#2042](https://github.com/shivmohith/openinference/issues/2042)) ([0e90576](https://github.com/shivmohith/openinference/commit/0e90576cd841c73f561ffbb98d9a39cfe035509d))
* **instrumentation:** add dangerously_using_project context manager ([#2134](https://github.com/shivmohith/openinference/issues/2134)) ([aed9db0](https://github.com/shivmohith/openinference/commit/aed9db05b93d1ae0cb7d8a49977de1926b038740))
...
* **openai:** standardize completions to indexed attribute format ([#2242](https://github.com/shivmohith/openinference/issues/2242)) ([478d17a](https://github.com/shivmohith/openinference/commit/478d17a5433bd6119a8d501899a5eadbd2accccf))
* **python:** get_first_span_id via a context manager ([#2013](https://github.com/shivmohith/openinference/issues/2013)) ([b0b080c](https://github.com/shivmohith/openinference/commit/b0b080c564a2fb72b8f6796cad603f0166bcc767))


### Bug Fixes

* Enable sampling when using OpenInference tracer ([#1782](https://github.com/shivmohith/openinference/issues/1782)) ([b4007cf](https://github.com/shivmohith/openinference/commit/b4007cffc5857028d6004aebd369877cab96d801))
* **instrumentation:** update openinference span kind helper to include prompt ([#2672](https://github.com/shivmohith/openinference/issues/2672)) ([6603d44](https://github.com/shivmohith/openinference/commit/6603d444d5a36aa661908da24ce6e9d1c78bc1fe))
...
* version upper bound on wrapt &lt;2.0 ([#2325](https://github.com/shivmohith/openinference/issues/2325)) ([57a4fa3](https://github.com/shivmohith/openinference/commit/57a4fa3329327bea41d6498c992d32ad87fd334c))
