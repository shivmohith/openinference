...
## [0.1.42](https://github.com/shivmohith/openinference/compare/python-openinference-instrumentation-openai-v0.1.41...python-openinference-instrumentation-openai-v0.1.42) (2026-02-02)
...
* **openai:** align embedding instrumentation with pending spec ([#2210](https://github.com/shivmohith/openinference/issues/2210)) ([df5b9d5](https://github.com/shivmohith/openinference/commit/df5b9d5dc080eddc4c91b6cb413eadb59f6c9982))
...
* **openai:** add tool_id accumulator for resposne ([#2241](https://github.com/shivmohith/openinference/issues/2241)) ([cb6e1a6](https://github.com/shivmohith/openinference/commit/cb6e1a6f68a6262b0eb50d045eef002b086288c4))
* **openai:** handle complex output types in responses API for openai 2 compat ([#2253](https://github.com/shivmohith/openinference/issues/2253)) ([a209e6a](https://github.com/shivmohith/openinference/commit/a209e6a1a33b36a497de5cc44d7059a723a75020))
* **openai:** handle string format for image_url in chat completions ([#2213](https://github.com/shivmohith/openinference/issues/2213)) ([4d09a7e](https://github.com/shivmohith/openinference/commit/4d09a7ec101a849ca74e36820caaff519ebe610e))
* **openai:** update lower bound on openinference-semantic-conventions ([#2279](https://github.com/shivmohith/openinference/issues/2279)) ([45cfad1](https://github.com/shivmohith/openinference/commit/45cfad1d27d247b1a58d08f10db6ed5896863c69))
