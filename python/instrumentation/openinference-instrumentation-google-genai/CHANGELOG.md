...
## [0.1.10](https://github.com/shivmohith/openinference/compare/python-openinference-instrumentation-google-genai-v0.1.9...python-openinference-instrumentation-google-genai-v0.1.10) (2026-02-02)


### Features

* Google Gen AI Tool Code Support ([#1763](https://github.com/shivmohith/openinference/issues/1763)) ([ec5cc3f](https://github.com/shivmohith/openinference/commit/ec5cc3f535cfb546f08506d18b93c373b494c7c2))


### Bug Fixes

* fix config_json serialization for GoogleGenAIInstrumentor ([#1855](https://github.com/shivmohith/openinference/issues/1855)) ([1702a1d](https://github.com/shivmohith/openinference/commit/1702a1d755d8ebc64fb3fa17e36579a6935d9dbd))
* google genai with pydantic ([#1724](https://github.com/shivmohith/openinference/issues/1724)) ([e2ea09a](https://github.com/shivmohith/openinference/commit/e2ea09a5395f47a5b60ec7961d22114293ebb4f1))
* **google-genai:** fix wrong tool attribute when setting llm input_message attribute ([#2260](https://github.com/shivmohith/openinference/issues/2260)) ([8ee0569](https://github.com/shivmohith/openinference/commit/8ee0569ae3e7bbf8c66f8bca2a34727d31cd007d))
* **google-genai:** including tool_use_prompt_token_count into prompt token count ([#2597](https://github.com/shivmohith/openinference/issues/2597)) ([b067ecb](https://github.com/shivmohith/openinference/commit/b067ecb133dd7dcf7eccf15d20450817a71953dd))
* **google-genai:** Set input message attributes for function call and function response parts ([#2252](https://github.com/shivmohith/openinference/issues/2252)) ([be4b9c1](https://github.com/shivmohith/openinference/commit/be4b9c150f6a33a1ee394d19f7c8e7c7886fe307))
